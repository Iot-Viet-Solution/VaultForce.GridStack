...
public class BlazorGridStackBodyOptions
{
    ...
    public BlazorColumnOptions? ColumnOptions { get; set; }
...
public class BlazorColumnOptions
{
    public Layout Layout { get; set; }
    public bool? BreakpointForWindow { get; set; }
    public List<BlazorBreakpoint> Breakpoints { get; set; } = [];
